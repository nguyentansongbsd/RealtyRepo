...
namespace Action_Quotation_PSGen
{
    public class Action_Quotation_PSGen : IPlugin
    {
            ...
            decimal baseContractInterest, decimal depositAmountPL)
        {
            ...
            decimal vatAmount = enHD.Contains("bsd_vat") ? ((Money)enHD["bsd_vat"]).Value : 0;
        ...
        decimal baseContractInterest, decimal depositAmountPL, decimal vatAmount, decimal netSellingPrice)
        {
            ...
            tmp["bsd_quotation"] = enHD.ToEntityReference();
            ...
            var fetchXmlKhongGop = $@"
                        <fetch>
                          <entity name='bsd_paymentschemedetail'>
                            ...
                            <filter type='and'>
                              <condition attribute='bsd_quotation' operator='eq' value='{enHD.Id}'/>
                              <condition attribute='statecode' operator='eq' value='0'/>
                            </filter>

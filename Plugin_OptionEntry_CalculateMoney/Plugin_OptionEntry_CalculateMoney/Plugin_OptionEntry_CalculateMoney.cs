...
namespace Plugin_OptionEntry_CalculateMoney
{
    public class Plugin_OptionEntry_CalculateMoney : IPlugin
    {
        ...
        void IPlugin.Execute(IServiceProvider serviceProvider)
        {
            ...
            if (context.MessageName == "Create" || context.MessageName == "Update")
            {
                ...
                Entity enTarget = service.Retrieve(target.LogicalName, target.Id, new ColumnSet(new string[]
                {
                    ...
                    "bsd_pricelevel", "bsd_packagesellingamount", "bsd_freightamount", "bsd_totalamountlessfreight", "bsd_landvaluededuction", "bsd_promotioncheck", "bsd_totaltax"
                }));
        ...
        private void delete_PromotionTransaction(Guid idQuote)
        {
            ...
            queryExpression.Criteria.AddCondition(new ConditionExpression("bsd_spa", ConditionOperator.Equal, idQuote));
        ...
        private void calculate_Promotion_createPromotionTransaction(string[] strArray, decimal unitprice, Entity enTarget, out decimal sumAmountPromotion)
        {
            ...
            foreach (Guid guid in strArraySum)
            {
                ...
                if (bsd_contractdeduction)
                {
                    ...
                    rsv["bsd_spa"] = enTarget.ToEntityReference();
        ...
        private void SetPrice(Entity enOE, ref Entity enUp, decimal bsd_detailamount, decimal bsd_totalamountlessfreight)
        {
